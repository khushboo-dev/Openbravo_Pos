...
public class SaveProviderCreator implements SaveProvider<Object> {
    ...
    public SaveProviderCreator(SentenceExec sentupdate, SentenceExec sentinsert, SentenceExec sentdelete) {
        m_sentupdate = sentupdate;
        m_sentinsert = sentinsert;
        m_sentdelete = sentdelete;
    }
    public SaveProviderCreator(TableDefinition table) {
        m_sentupdate = table.getUpdateSentence();
        m_sentdelete = table.getDeleteSentence();
        m_sentinsert = table.getInsertSentence();
    }
    public SaveProviderCreator(TableDefinition table, int[] fields) {
    ...
    public Object saveData(Object value) throws BasicException {
        throw new UnsupportedOperationException("Not supported yet.");
    }
}
