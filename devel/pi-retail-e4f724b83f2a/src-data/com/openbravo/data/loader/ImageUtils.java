...
public class ImageUtils {
    ...
    public static byte[] writeProperties(Properties props) {
    ...
    public static Properties readStringProperties(String props) {
        Properties prop = new Properties();
        try {
            if (props != null) {
                prop.loadFromXML(new ByteArrayInputStream(props.getBytes("UTF-8")));
            }
        } catch (IOException e) {
        }
        return prop;
    ...
    public static String writeStringProperties(Properties props) {
