...
public abstract class QBFCompareEnum {
    ...
    public final static QBFCompareEnum COMP_NONE = new QBFCompareEnum(0, "qbf.none") { 
        ...
        public String getHQLExpression(String field, String paramname) { return null; }
        public boolean isHQLValue() { return false; }
    };
    public final static QBFCompareEnum COMP_ISNULL = new QBFCompareEnum(1, "qbf.null") {
        ...
        public String getHQLExpression(String field, String paramname) { return field + " is null"; }
        public boolean isHQLValue() { return false; }
    };
    public final static QBFCompareEnum COMP_ISNOTNULL = new QBFCompareEnum(2, "qbf.notnull") {
        ...
        public String getHQLExpression(String field, String paramname) { return field + " is not null"; }
        public boolean isHQLValue() { return false; }
    };
    public final static QBFCompareEnum COMP_RE = new QBFCompareEnum(3, "qbf.re") {
        ...
        public String getHQLExpression(String field, String paramname) { return field + " like :" + paramname; }
        public boolean isHQLValue() { return true; }
    };
    public final static QBFCompareEnum COMP_EQUALS = new QBFCompareEnum(3, "qbf.equals") {
        ...
        public String getHQLExpression(String field, String paramname) { return field + " = :" + paramname; }
        public boolean isHQLValue() { return true; }
    };
...
//    public final static int COMP_CONTAINS = 13;    
    ...
    public abstract String getHQLExpression(String field, String paramname);
    public abstract boolean isHQLValue();
}
