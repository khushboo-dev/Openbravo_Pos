...
public class JSaver extends JPanel implements BrowseListener {
    ...
    public void updateIndex(int iIndex, int iCounter) {
        ...
        jbtnNew.setEnabled(m_bd.canSaveData());
        jbtnSave.setEnabled(m_bd.canSaveData());
