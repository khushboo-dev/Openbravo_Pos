...
public class Row {
    ...
    public SaveProviderCreator getSaveProvider(Session s, Table t) {
        return new SaveProviderCreator(getUpdateSentence(s, t), getInsertSentence(s, t), getDeleteSentence(s, t));
    }
