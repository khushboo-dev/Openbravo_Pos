...
public class JCustomerFinder extends javax.swing.JDialog {
    ...
    private EBusinessPartner selectedCustomer;
    private ServiceQBF<EBusinessPartner> lpr;
    ...
    public EBusinessPartner getSelectedCustomer() {
    ...
    private void init(DataLogicCustomers dlCustomers) {
        ...
        lpr = dlCustomers.getCustomerList();
    ...
    public void search(EBusinessPartner customer) {
    ...
    public Object[] getParameters() throws BasicException {
        ...
        if (m_jtxtTaxID.getText() == null || m_jtxtTaxID.getText().equals("")) {
            params[0] = new QBFParam("taxID", QBFCompareEnum.COMP_NONE, null, JSONFormats.STRING);
        } else {
            params[0] = new QBFParam("taxID", QBFCompareEnum.COMP_RE, "%" + m_jtxtTaxID.getText() + "%", JSONFormats.STRING);
        }

        // SearchKey
        if (m_jtxtSearchKey.getText() == null || m_jtxtSearchKey.getText().equals("")) {
            params[1] = new QBFParam("searchKey", QBFCompareEnum.COMP_NONE, null, JSONFormats.STRING);
        } else {
            params[1] = new QBFParam("searchKey", QBFCompareEnum.COMP_RE,  "%" + m_jtxtSearchKey.getText() + "%", JSONFormats.STRING);
        }

        // Name
        if (m_jtxtName.getText() == null || m_jtxtName.getText().equals("")) {
            params[2] = new QBFParam("name", QBFCompareEnum.COMP_NONE, null, JSONFormats.STRING);
        } else {
            params[2] = new QBFParam("name", QBFCompareEnum.COMP_RE, "%" + m_jtxtName.getText() + "%", JSONFormats.STRING);
        }
    ...
    public void executeSearch() {
        try {
            jListCustomers.setModel(new MyListData(lpr.list(getParameters())));
    ...
    private void jcmdOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcmdOKActionPerformed
        ...
        selectedCustomer = (EBusinessPartner) jListCustomers.getSelectedValue();
        dispose();
