...
public class JPaymentCheque extends javax.swing.JPanel implements JPaymentInterface {
    ...
    public JPaymentCheque(JPaymentNotifier notifier, ETerminalPayment terminalPayment) {
    ...
    public XOrderPayment executePayment() {
        return new XOrderPaymentVoucher(terminalPayment, paid); // Cheque ETerminal Payment
    }
