...
public abstract class JPaymentSelect extends javax.swing.JDialog 
    ...
    private EBusinessPartner customer;
    ...
    public List<XOrderPayment> getSelectedPayments() {
        return m_aPaymentInfo.getPayments();
    }
            
    public boolean showDialog(double total, EBusinessPartner customer) {
    ...
    protected abstract XOrderPayment getDefaultPayment(double total);
    ...
    protected void addTabPayment(JPaymentCreator jpay) {
        ...
        if (app.getUser().getUser().hasPermission(jpay.getKey()) && jpay.getTerminalPayment() != null) {

            // Added if and only if the user has permissions and exists a ETerminalPayment configurated.
    ...
    public abstract class JPaymentCreator {
        ...
        public final ETerminalPayment getTerminalPayment() {
            return App.getInstance().getTerminalPayment(getKey());
        }
    }

    public class JPaymentCashCreator extends JPaymentCreator {
        public JPaymentInterface createJPayment() {
            return new JPaymentCashPos(JPaymentSelect.this, getTerminalPayment());
        }
    ...
    public class JPaymentChequeCreator extends JPaymentCreator {
        public JPaymentInterface createJPayment() {
            return new JPaymentCheque(JPaymentSelect.this, getTerminalPayment());
        }
    ...
    public class JPaymentVoucherCreator extends JPaymentCreator {
        public JPaymentInterface createJPayment() {
            return new JPaymentVoucher(JPaymentSelect.this, getTerminalPayment());
        }
        public String getKey() { return "payment.voucher"; }
        public String getLabelKey() { return "tab.voucher"; }
        public String getIconKey() { return "/com/openbravo/images/knotes.png"; }
    }
   
    public class JPaymentMagcardCreator extends JPaymentCreator {
        public JPaymentInterface createJPayment() {
    ...
    public class JPaymentFreeCreator extends JPaymentCreator {
        public JPaymentInterface createJPayment() {
    ...
    public class JPaymentDebtCreator extends JPaymentCreator {
        public JPaymentInterface createJPayment() {
            return new JPaymentDebt(JPaymentSelect.this, getTerminalPayment());
        }
    ...
    public class JPaymentCashRefundCreator extends JPaymentCreator {
        public JPaymentInterface createJPayment() {
            return new JPaymentRefund(JPaymentSelect.this, getTerminalPayment());
        }
    ...
    public class JPaymentChequeRefundCreator extends JPaymentCreator {
        public JPaymentInterface createJPayment() {
            return new JPaymentRefund(JPaymentSelect.this, getTerminalPayment());
        }
    ...
    public class JPaymentPaperRefundCreator extends JPaymentCreator {
        public JPaymentInterface createJPayment() {
            return new JPaymentRefund(JPaymentSelect.this, getTerminalPayment());
        }
        public String getKey() { return "refund.voucher"; }
        public String getLabelKey() { return "tab.voucher"; }
        public String getIconKey() { return "/com/openbravo/images/knotes.png"; }
    }    
       
    public class JPaymentMagcardRefundCreator extends JPaymentCreator {
       public JPaymentInterface createJPayment() {     
            return new JPaymentMagcard(app, JPaymentSelect.this);
        }
    ...
    private void printState() {
        ...
        ((JPaymentInterface) m_jTabPayment.getSelectedComponent()).activate(customer, m_dTotal - m_aPaymentInfo.getTotal());
    }
    ...
    private void m_jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jButtonAddActionPerformed
        ...
        XOrderPayment returnPayment = ((JPaymentInterface) m_jTabPayment.getSelectedComponent()).executePayment();
