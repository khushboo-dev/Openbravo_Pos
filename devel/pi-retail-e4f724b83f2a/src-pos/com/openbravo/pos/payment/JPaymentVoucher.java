...
public class JPaymentVoucher extends javax.swing.JPanel implements JPaymentInterface {
    ...
    public JPaymentVoucher(JPaymentNotifier notifier, ETerminalPayment terminalPayment) {
    ...
    public XOrderPayment executePayment() {
        ...
        return new XOrderPaymentVoucher(terminalPayment, ticket);
    }    
    ...
    private void printState() {
        ...
        m_jMoneyEuros.setText(Formats.CURRENCY.formatValue(new Double(ticket)));
        
        int iCompare = RoundUtils.compare(ticket, total);
        
        // it is allowed to pay more
        notifier.setStatus(ticket > 0.0, iCompare >= 0);
    }
