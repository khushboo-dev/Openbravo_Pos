...
public class ProductFilterSales extends javax.swing.JPanel implements EditorCreator {
    ...
    public Object createValue() throws BasicException {
        ...
        // Precio de venta
        afilter[3] = m_jPriceSell.getDoubleValue();
        afilter[2] = afilter[3] == null ? QBFCompareEnum.COMP_NONE : m_jCboPriceSell.getSelectedItem();
        ...
        if (m_CategoryModel.getSelectedKey() == null) {
            ...
            afilter[5] = m_CategoryModel.getSelectedKey();
        }
        ...
        if (m_jtxtBarCode.getText() == null || m_jtxtBarCode.getText().equals("")) {
            ...
            afilter[7] = "%" + m_jtxtBarCode.getText() + "%";
        }
    ...
    private void initComponents() {
        ...
        add(jLabel5);
        jLabel5.setBounds(20, 40, 110, 17);
        add(m_jtxtName);
