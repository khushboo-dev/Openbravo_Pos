...
SELECT GET_UUID(), 'FF8080812AFBCB14012AFBD3E373001F', '0', '0', '0', '3D5764CB14C140A8BC9F0655C7508652', OBPOS_POS_ID FROM OBPOS_POS WHERE CLASSNAME IN (
...
'3D5764CB14C140A8BC9F0655C7508652', AD_WINDOW_ID, ISREADWRITE FROM AD_WINDOW_ACCESS WHERE AD_ROLE_ID = 'FF8081812250326E012250353BDE0006'
...
SELECT GET_UUID(), AD_CLIENT_ID, '0', '0', '0',
'3D5764CB14C140A8BC9F0655C7508652', AD_PROCESS_ID, ISREADWRITE FROM AD_PROCESS_ACCESS WHERE AD_ROLE_ID = 'FF8081812250326E012250353BDE0006'

INSERT INTO AD_FORM_ACCESS(AD_FORM_ACCESS_ID, AD_CLIENT_ID, AD_ORG_ID, CREATEDBY, UPDATEDBY,
AD_ROLE_ID, AD_FORM_ID, ISREADWRITE)
SELECT GET_UUID(), AD_CLIENT_ID, '0', '0', '0',
'3D5764CB14C140A8BC9F0655C7508652', AD_FORM_ID, ISREADWRITE FROM AD_FORM_ACCESS WHERE AD_ROLE_ID = 'FF8081812250326E012250353BDE0006'
...
'3D5764CB14C140A8BC9F0655C7508652', IS_ORG_ADMIN FROM AD_ROLE_ORGACCESS WHERE AD_ROLE_ID = 'FF8081812250326E012250353BDE0006'
