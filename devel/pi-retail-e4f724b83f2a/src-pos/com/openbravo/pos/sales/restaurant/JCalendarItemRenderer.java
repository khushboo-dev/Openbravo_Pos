...
public class JCalendarItemRenderer extends javax.swing.JPanel implements ListCellRenderer, Serializable {
    ...
    public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
        ...
        if (value == null) {
            ...
            EReservation reservation = (EReservation) value;
            m_jTime.setText(Formats.TIME.formatValue(reservation.getDatenew()));
            m_jTitle.setText(Formats.STRING.formatValue(reservation.getTitle()));
            m_jChairs.setText(Formats.INT.formatValue(reservation.getChairs()));
            m_bDone = reservation.isDone();
            m_jDescription.setText(Formats.STRING.formatValue(reservation.getDescription()));
        }
