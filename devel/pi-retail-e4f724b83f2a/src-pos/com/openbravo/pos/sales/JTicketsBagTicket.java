...
public class JTicketsBagTicket extends JTicketsBag {
    ...
    private EOrder m_ticket;
    private EOrder m_ticketCopy;
    ...
    public void activate() {
        ...
        m_jEdit.setVisible(m_App.getUser().getUser().hasPermission("sales.EditTicket"));
        m_jRefund.setVisible(m_App.getUser().getUser().hasPermission("sales.RefundTicket"));
        m_jPrint.setVisible(m_App.getUser().getUser().hasPermission("sales.PrintTicket"));
    ...
    public void deleteTicket() {
        ...
        if (m_ticketCopy != null) {           
            ...
            try {               
                m_dlSales.deleteTicket(m_ticketCopy, m_App.getTerminal().getWarehouse());
    ...
    private void printTicket() {
        ...
        m_jEdit.setEnabled(
                m_ticket != null
                && (m_ticket.getTicketType() == EOrder.RECEIPT_NORMAL || m_ticket.getTicketType() == EOrder.RECEIPT_REFUND));
        m_jRefund.setEnabled(m_ticket != null && m_ticket.getTicketType() == EOrder.RECEIPT_NORMAL);
    ...
    private void m_jRefundActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jRefundActionPerformed
        ...
        for(int i = 0; i < m_ticket.getLinesCount(); i++) {
            EOrderLine newline = new EOrderLine(m_ticket.getLine(i));
        ...
        EOrder refundticket = new EOrder();
        refundticket.setTicketType(EOrder.RECEIPT_REFUND);
        refundticket.setCustomer(m_ticket.getCustomer(), m_ticket.getCustomerIdentifier());
