...
public class JPanelTicketSales extends JPanelTicket {
    ...
    protected Component getSouthComponent() {
        m_cat = new JCatalog(dlSales, app.getPriceListVersion(), panelconfig);
    ...
    protected JTicketsBag getJTicketsBag() {
        return JTicketsBag.createTicketsBag(app.getProperties().getProperty("machine.ticketsbag"), app, this);
    }
    ...
    private class CatalogListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            buttonTransition((EProduct) e.getSource());
        }  
    }
        ...
        public void valueChanged(ListSelectionEvent e) {      
            ...
            if (!e.getValueIsAdjusting()) {
                ...
                if (i >= 0) {
                    ...
                    if (i >= 0) {
                        m_cat.showCatalogPanel(m_oTicket.getLine(i).getProduct());
                    } else {
                        m_cat.showCatalogPanel(null);
                    }
                }
