...
public class JProductLineEdit extends javax.swing.JDialog {
    ...
    private EOrderLine returnLine;
    private EOrderLine m_oLine;
    ...
    private EOrderLine init(AppView app, EOrderLine oLine) throws BasicException {
        // Inicializo los componentes
        initComponents();
        setLocationRelativeTo(getParent());

        if (oLine.getTax() == null) {
            throw new BasicException(AppLocal.getIntString("message.cannotcalculatetaxes"));
        }

        m_oLine = new EOrderLine(oLine);
        m_bunitsok = true;
        m_bpriceok = true;

        m_jName.setEnabled(m_oLine.getProduct() == null && app.getUser().getUser().hasPermission("com.openbravo.pos.sales.JPanelTicketEdits"));
        m_jPrice.setEnabled(app.getUser().getUser().hasPermission("com.openbravo.pos.sales.JPanelTicketEdits"));
        m_jPriceTax.setEnabled(app.getUser().getUser().hasPermission("com.openbravo.pos.sales.JPanelTicketEdits"));
        ...
        m_jTaxrate.setText(oLine.getTax().getName());
    ...
    public static EOrderLine showMessage(Component parent, AppView app, EOrderLine oLine) throws BasicException {
