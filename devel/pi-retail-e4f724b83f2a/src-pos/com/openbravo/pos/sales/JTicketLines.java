...
public class JTicketLines extends javax.swing.JPanel {
    ...
    public void setTicketLine(int index, EOrderLine oLine){
        
        m_jTableModel.setRow(index, oLine);  
    }
    
    public void addTicketLine(EOrderLine oLine) {
    ...
    public void insertTicketLine(int index, EOrderLine oLine) {
...
//        private AppView m_App;
        ...
        public void setRow(int index, EOrderLine oLine){
        ...
        public void addRow(EOrderLine oLine) {
            
            insertRow(m_rows.size(), oLine);
        }
        
        public void insertRow(int index, EOrderLine oLine) {
