...
public class JTicketsBagShared extends JTicketsBag {
    ...
    private ESharedTicketView currentticket = null;
    ...
    public void activate() {
        ...
        // Authorization
        m_jDelTicket.setEnabled(m_App.getUser().getUser().hasPermission("com.openbravo.pos.sales.JPanelTicketEdits"));
    ...
    private void saveCurrentTicket() {
        ...
        if (currentticket != null) {
            try {
                ESharedTicket sharedticket = dlReceipts.saveSharedTicket(currentticket.getId(), null, m_panelticket.getActiveTicket());
                currentticket.setId(sharedticket.getId());
    ...
    private void setActiveTicket(String id) throws BasicException{
        ...
        // BEGIN TRANSACTION
        EOrder ticket = dlReceipts.getSharedTicket(id);
        dlReceipts.deleteSharedTicket(id);
        if (ticket == null)  {
            // Does not exists ???
            throw new BasicException(AppLocal.getIntString("message.noticket"));
        } else {           
            currentticket = new ESharedTicketView();
    ...
    private void selectValidTicket() {
        ...
        try {
            List<ESharedTicketView> l = dlReceipts.getSharedTicketList();
            if (l.isEmpty()) {
                newTicket();
            } else {
    ...
    private void newTicket() {      
        ...
        currentticket = new ESharedTicketView(); // m_fmtid.format(ticket.getId());
        m_panelticket.setActiveTicket(new EOrder(), null);
    }
