...
public class StockDiaryEditor extends javax.swing.JPanel implements EditorRecord {
    ...
    private void assignProduct(EProduct prod) {
        ...
        if (jproduct.isEnabled()) {
            if (prod == null) {
                ...
                Double dPrice = reason.getPrice(prod.getPriceSell(), prod.getPriceSell());
    ...
    private void assignProductByCode() {
        try {
            EProduct oProduct = m_dlSales.getProductInfoByCode(m_App.getPriceListVersion(), m_jcodebar.getText());
            if (oProduct == null) {       
                assignProduct(null);
    ...
    private void assignProductByReference() {
        try {
            EProduct oProduct = m_dlSales.getProductInfoByReference(m_App.getPriceListVersion(), m_jreference.getText());
            if (oProduct == null) {       
                assignProduct(null);
                Toolkit.getDefaultToolkit().beep();                   
            } else {
    ...
    private class CatalogListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            assignProduct((EProduct) e.getSource());
        }  
    }    
    ...
    private void jEditProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jEditProductActionPerformed
        ...
        assignProduct(JProductFinder.showMessage(this, m_App, m_dlSales));
