...
public class ProductsEditor extends JPanel implements EditorRecord {
    ...
    private ServiceHQL<ECategory> m_sentcat;
    private ComboBoxValModel m_CategoryModel;

    private ServiceHQL<ETaxCategory> taxcatsent;
    ...
    public ProductsEditor(DataLogicSales dlSales, DirtyManager dirty) {
        ...
        m_sentcat = dlSales.getCategoryService();
        m_CategoryModel = new ComboBoxValModel();
        
        // The taxes model
        taxcatsent = dlSales.getTaxCategoryService();
    ...
    private void calculatePriceSellTax() {
        ...
        if (!reportlock) {
            ...
            if (dPriceSell == null) {
                ...
                double dTaxRate = App.getInstance().getTaxesLogic().getTaxRate((ETaxCategory) taxcatmodel.getSelectedItem(), new Date());
