...
public class TaxEditor extends JPanel implements EditorRecord {
    ...
    private ServiceHQL<ETax> taxparentsent;
    ...
    public TaxEditor(AppView app, DirtyManager dirty) {
        ...
        taxparentsent = dlSales.getTaxService();
    ...
    public void refresh() {
        ...
        try {
            a = taxparentsent.list(App.getInstance().getOrganizationLocation().getCountry());
