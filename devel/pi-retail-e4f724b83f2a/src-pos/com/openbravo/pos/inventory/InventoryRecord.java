...
public class InventoryRecord {
    ...
    private EWarehouse m_locationOri;
    private List<InventoryLine> m_invlines;
    
    /** Creates a new instance of InventoryRecord */
    public InventoryRecord(Date d, MovementReason reason, EWarehouse location, List<InventoryLine> invlines) {
        m_dDate = d;
        m_reason = reason;
