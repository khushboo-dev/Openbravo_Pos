...
public class AuxiliarEditor extends javax.swing.JPanel implements EditorRecord {
    ...
    public void setInsertProduct(EProduct prod) {
    ...
    private void assignProductByCode() {
        try {
            EProduct prod = m_dlSales.getProductInfoByCode(app.getPriceListVersion(), m_jBarcode.getText());
            assignProduct(prod);
            if (prod == null) {
    ...
    private void assignProductByReference() {
        try {
            EProduct prod = m_dlSales.getProductInfoByReference(app.getPriceListVersion(), m_jReference.getText());
            assignProduct(prod);
            if (prod == null) {
                Toolkit.getDefaultToolkit().beep();       
            }
    ...
    private void m_jSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jSearchActionPerformed
        ...
        assignProduct(JProductFinder.showMessage(this, app, m_dlSales, JProductFinder.PRODUCT_AUXILIAR));
