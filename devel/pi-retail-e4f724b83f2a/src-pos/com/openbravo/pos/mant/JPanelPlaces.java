...
public class JPanelPlaces extends JPanelTable {
    ...
    protected void init() {
        ...
        tplaces = new TableDefinition(app.getSession(),
            "OBPOS_PLACES"
            , new String[] {"OBPOS_PLACES_ID", "NAME", "X", "Y", "OBPOS_FLOORS_ID"}
            , new String[] {"OBPOS_PLACES_ID", AppLocal.getIntString("Label.Name"), "X", "Y", AppLocal.getIntString("label.placefloor")}
    ...
    public SaveProvider createSaveProvider() {
        return new SaveProviderCreator(tplaces);
    }
