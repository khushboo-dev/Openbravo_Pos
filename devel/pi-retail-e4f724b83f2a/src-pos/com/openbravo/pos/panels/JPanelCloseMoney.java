...
//                if (m_App.getActiveCash().getEnd() == null) {
//                    m_App.getActiveCash().setEnd(dNow);
//                    m_dlSystem.putCash(m_App.getActiveCash());
//                }
...
//                EClosedCash c = new EClosedCash();
//                c.setId(null); // new
//                c.setTerminal(m_App.getActiveCash().getTerminal());
//                c.setSequence(m_App.getActiveCash().getSequence() + 1);
//                c.setStart(dNow);
//                c.setEnd(null);
//
//                m_App.setActiveCash(m_dlSystem.putCash(c));
//
