...
public class AuxiliarFilter extends javax.swing.JPanel implements ReportEditorCreator {
    ...
    private void assignProductByCode() {
        try {
            EProduct prod = m_dlSales.getProductInfoByCode(app.getPriceListVersion(), m_jBarcode1.getText());
            if (prod == null) {
    ...
    private void assignProductByReference() {
        try {
            EProduct prod = m_dlSales.getProductInfoByReference(app.getPriceListVersion(), m_jReference1.getText());
            if (prod == null) {
                Toolkit.getDefaultToolkit().beep();
            }
            assignProduct(prod);
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        assignProduct(JProductFinder.showMessage(this, app, m_dlSales, JProductFinder.PRODUCT_NORMAL));
