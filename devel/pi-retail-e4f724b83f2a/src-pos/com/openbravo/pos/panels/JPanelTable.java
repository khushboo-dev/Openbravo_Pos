...
public abstract class JPanelTable extends JPanel implements JPanelView, BeanFactoryApp {
    ...
    public abstract EditorRecord createEditor();    
    ...
    public void activate() throws BasicException {
        ...
        if (bd == null) {
            ...
            EditorRecord editor = createEditor();

            // init browsable editable data
            bd = new BrowsableEditableData(createListProvider(), createSaveProvider(), editor, dirty);
