...
//    private ServiceHQL<EPersonView> m_sentcat;
...
//        m_sentcat = dlSales.getPersonViewService();
...
//            afilter[11] = ((EPersonView)jcboUser.getSelectedItem()).getName();
        }
...
private void btnCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCustomerActionPerformed
        ...
        jtxtCustomer.setText(finder.getSelectedCustomer() == null
            ? null
            : finder.getSelectedCustomer().toString());
