...
public class JPrincipalApp extends javax.swing.JPanel implements AppUserView {
    ...
    public JPrincipalApp(JRootApp appview, EUser appuser) {
...
//        m_principalnotificator.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createLineBorder(javax.swing.UIManager.getDefaults().getColor("TextField.shadow")), javax.swing.BorderFactory.createEmptyBorder(1, 5, 1, 5)));        
        ...
        try {
            ...
            m_jPanelLeft.setViewportView(getScriptMenu(((DataLogicSystem) m_appview.getBean("com.openbravo.pos.forms.DataLogicSystem")).getResourceAsText("Menu.Root")));
...
//        public JTaskPaneGroup getTaskGroup() {
    ...
    public void activate() {
        ...
        if (m_actionfirst != null) {
            ...
            if (m_actionfirst instanceof ExitAction) {
                // Only the exit action defined...
                MessageInf msg = new MessageInf(MessageInf.SGN_WARNING, AppLocal.getIntString("message.noactions"));
                msg.show(JPrincipalApp.this);
            }
    ...
    private class ChangePasswordAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent evt) {
            ...
            // PENDING: Create new change password action
              JMessageDialog.showMessage(JPrincipalApp.this, new MessageInf(MessageInf.SGN_WARNING, "Not supported operation"));
...
//            }
    ...
    public HttpSession getHttpSession() {
        return m_appuser.getHttpSession();
    }
        ...
        if (m_appuser.hasPermission(sTaskClass)) {            
            ...
            if (m_jLastView == null || (m_jMyView != m_jLastView && m_jLastView.deactivate())) {
                ...
                if (m_jMyView == null) {   
                    ...
                    m_jMyView.getViewComponent().applyComponentOrientation(getComponentOrientation());
                    m_jPanelContainer.add(m_jMyView.getViewComponent(), sTaskClass);
