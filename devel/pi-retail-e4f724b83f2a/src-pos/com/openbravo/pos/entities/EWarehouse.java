 ...
 * @author adrian
 */
public class EWarehouse extends EBean {
    ...
    public static ClassEBean<EWarehouse> getClassEBean() {
        return new ClassEBean<EWarehouse>() {
            @Override
            public EWarehouse create() {
                return new EWarehouse();
            }
