 ...
 * @author adrian
 */
public class EFloorView extends EBean {
    ...
    public static ClassEBean<EFloorView> getClassEBean() {
        return new ClassEBean<EFloorView>() {
            @Override
            public EFloorView create() {
                return new EFloorView();
            }

            @Override
            public String getEntity() {
                return "OBPOS_FloorsView";
            }
        };
    }
