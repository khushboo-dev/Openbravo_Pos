...
public class TaxDAO extends BaseJdbcDAO implements Serializable {
    ...
    public TaxInfo getTax(String id) {
        ...
        String sqlStr = "SELECT * FROM C_TAX WHERE C_BP_TAXCATEGORY_ID = ?";
     ...
     public List<TaxInfo> getTaxList() {
        ...
        String sqlStr = "SELECT C_TAX_ID, NAME, C_TAXCATEGORY_ID, C_BP_TAXCATEGORY_ID, PARENT_TAX_ID, RATE, CASCADE, LINE FROM C_TAX ORDER BY NAME";
        List<TaxInfo> list = new ArrayList<TaxInfo>();
        try {
            //get connection
            con = getConnection();
