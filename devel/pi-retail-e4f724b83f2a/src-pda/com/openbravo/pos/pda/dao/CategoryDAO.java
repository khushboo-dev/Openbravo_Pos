...
public class CategoryDAO extends BaseJdbcDAO {
    ...
    public List<CategoryInfo> findAllCategories() {
        ...
        String sqlStr = "select * from OBPOS_CATEGORIES where PARENT_OBPOS_CATEGORIES_ID IS NULL order by NAME";
    ...
    public List<CategoryInfo> findAllSubcategories(String id) {
        ...
        ResultSet rs = null;
        List<CategoryInfo> vos = null;
        String sqlStr = "select * from OBPOS_CATEGORIES where PARENT_OBPOS_CATEGORIES_ID = ? order by NAME";
