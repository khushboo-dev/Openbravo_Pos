...
public class ProductDAO extends BaseJdbcDAO {
    ...
    public List<ProductInfo> findAllAuxiliars(String id) {
        ...
        String sqlStr = "SELECT * FROM OBPOS_PRODUCTS P, OBPOS_PRODUCTS_COM COM WHERE COM.OBPOS_PRODUCTS_ID=? AND P.OBPOS_PRODUCTS_ID = COM.RELATED_OBPOS_PRODUCTS_ID ORDER BY P.NAME";
    ...
    public ProductInfo findProductById(String productId) {
        ...
        String sqlStr = "SELECT * FROM OBPOS_PRODUCTS WHERE OBPOS_PRODUCTS_ID = ?";
    ...
    public List<ProductInfo> findProductsByCategory(String categoryId) {
        ...
        ResultSet rs = null;
        List<ProductInfo> vos = null;
        String sqlStr = isPostgre() 
                ? "SELECT * FROM OBPOS_PRODUCTS P, OBPOS_PRODUCTS_CAT PCAT WHERE P.OBPOS_CATEGORIES_ID = ? AND P.OBPOS_PRODUCTS_ID = PCAT.OBPOS_PRODUCTS_ID" +
