...
public class TicketDAO extends BaseJdbcDAO implements Serializable {
    ...
    public TicketInfo getTicket(String id) {
        ...
        String sqlStr = "Select CONTENT from OBPOS_SHAREDTICKETS where OBPOS_SHAREDTICKETS_ID = ?";
    ...
    public void initTicket(String id) {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String sqlStr = "INSERT INTO OBPOS_SHAREDTICKETS (OBPOS_SHAREDTICKETS_ID, NAME, CONTENT) VALUES (?, ?, ?)";
        TicketInfo ticket = new TicketInfo();
        try {
            //get connection
            con = getConnection();
    ...
    public void updateTicket(String ticketId, TicketInfo ticket) {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String sqlStr = "UPDATE OBPOS_SHAREDTICKETS SET CONTENT = ? WHERE OBPOS_SHAREDTICKETS_ID = ?";
        try {
            //get connection
            con = getConnection();
            //prepare statement
    ...
    public void deleteTicket(String id) {
        Connection con = null;
        PreparedStatement ps = null;
        String sqlStr = "DELETE FROM OBPOS_SHAREDTICKETS WHERE OBPOS_SHAREDTICKETS_ID = ?";
        try {
            //get connection
            con = getConnection();
            //prepare statement
