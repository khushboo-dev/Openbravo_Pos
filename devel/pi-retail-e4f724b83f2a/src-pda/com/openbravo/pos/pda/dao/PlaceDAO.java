...
public class PlaceDAO extends BaseJdbcDAO {
    ...
    public List<Place> findAllPlaceByFloor(String floorId) {
        ...
        ResultSet rs = null;
        List<Place> vos = null;
        String sqlStr = "Select * from OBPOS_PLACES where OBPOS_FLOORS_ID = ? order by NAME";
    ...
    public List<Place> findAllBusyPlacesByFloor(String floorId) {
        ...
        ResultSet rs = null;
        List<Place> vos = null;
        String sqlStr = "SELECT * FROM OBPOS_PLACES P, OBPOS_SHAREDTICKETS S WHERE OBPOS_FLOORS_ID = ? AND P.OBPOS_PLACES_ID = S.OBPOS_SHAREDTICKETS_ID";
    ...
    public Place findPlaceById(String placeId) {
        ...
        ResultSet rs = null;
        Place vo = null;
        String sqlStr = "Select * from OBPOS_PLACES where OBPOS_PLACES_ID = ?";
    ...
    public void setTableBusy(String placeId, String placeName) {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String sqlStr = "INSERT INTO OBPOS_SHAREDTICKETS (OBPOS_SHAREDTICKETS_ID, NAME) VALUES (?, ?)";
